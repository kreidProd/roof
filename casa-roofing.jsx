...
/* ================================================================
   CASA ROOFING, LLC — SCHERTZ / SAN ANTONIO, TX
   Est. 2017 · Owner: Brent Slaughter
   ================================================================ */
const C = {
  name: "Casa Roofing, LLC",
  nameShort: "Casa Roofing",
  phone: "(623) 418-3204",
  phoneRaw: "6234183204",
  email: "casaroofingservices@gmail.com",
  city: "Phoenix",
  state: "AZ",
  serviceArea: "the Phoenix Metro & Surrounding Areas",
  address: "16021 N 30th St, Phoenix, AZ 85032",
  tagline: "Phoenix's Trusted Roofing Experts.",
  rating: "5.0",
  reviewCount: "40",
  yearsExp: "17+",
...
const REVIEWS = [
  { text: "Casa Roofing replaced our roof after monsoon damage and handled the entire insurance process. Professional, fast, and the new roof looks amazing. Highly recommend!", name: "Verified Customer", loc: "Google Review — Phoenix, AZ" },
  { text: "Used Casa Roofing for our full roof replacement — done beautifully. Fair pricing and Randy stands behind his work 100%. Will use again for any exterior project.", name: "Verified Customer", loc: "Google Review — Scottsdale, AZ" },
  { text: "From the initial inspection to final cleanup, Casa Roofing was top-notch. They even helped us navigate our insurance claim. Can't say enough good things about this crew.", name: "Verified Customer", loc: "Google Review — Glendale, AZ" },
];

const SERVICES = [
  { title: "Roofing", desc: "Complete roof replacement and repair — shingle, metal, tile, and flat roofing for residential and commercial properties.", icon: "home" },
  { title: "Gutters", desc: "Seamless gutter installation, repair, and gutter guard systems to protect your home from water damage.", icon: "tool" },
  { title: "Fencing", desc: "Wood, vinyl, chain-link, and iron fencing. Privacy, security, and curb appeal — built to last.", icon: "fence" },
  { title: "Decking", desc: "Custom deck construction and restoration. Wood, composite, and Trex decking for your outdoor living space.", icon: "deck" },
  { title: "Windows", desc: "Energy-efficient window replacement and installation. Lower your bills and upgrade your home's look.", icon: "window" },
  { title: "Painting", desc: "Interior and exterior painting with premium materials. Clean lines, lasting finish, professional crew.", icon: "paint" },
];

const AREAS = ["Phoenix", "Scottsdale", "Glendale", "Mesa", "Tempe", "Chandler", "Gilbert", "Peoria", "Surprise", "Goodyear", "Avondale", "Cave Creek"];
...
.tb .el{display:inline-block;background:var(--acc);color:var(--dk);font-size:10px;font-weight:700;padding:2px 8px;border-radius:3px;margin-right:8px;letter-spacing:1px;text-transform:uppercase;vertical-align:middle}
...
.hero-bg::after{content:'';position:absolute;inset:0;background:linear-gradient(145deg,rgba(26,60,94,.94) 0%,rgba(36,82,122,.87) 50%,rgba(13,27,42,.82) 100%)}
...
.cta{display:block;width:100%;padding:15px;background:var(--acc);color:var(--dk);border:none;border-radius:8px;font-family:var(--fd);font-size:17px;font-weight:700;text-transform:uppercase;letter-spacing:1px;cursor:pointer;transition:background .2s,transform .1s;text-align:center}
.cta:hover{background:var(--accH);transform:translateY(-1px);color:var(--wh)}
...
.opt:hover{border-color:var(--priL);background:rgba(26,60,94,.03)}
.opt.sel{border-color:var(--pri);background:rgba(26,60,94,.06)}
...
const Ic={
  ...
  star:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><path d="M8 1l2.2 4.5 5 .7-3.6 3.5.9 5L8 12.4 3.5 14.7l.9-5L.8 6.2l5-.7L8 1z" fill="#D4A24E"/></svg>,
  clk:<svg width="16" height="16" fill="none" viewBox="0 0 16 16"><circle cx="8" cy="8" r="6" stroke="#1A3C5E" strokeWidth="2" fill="none"/><path d="M8 4v4l3 2" stroke="#1A3C5E" strokeWidth="2" fill="none" strokeLinecap="round"/></svg>,
  ...
  fence:<svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path d="M4 3v18M10 3v18M16 3v18M22 3v18M2 8h6M8 8h6M14 8h6M2 16h6M8 16h6M14 16h6" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  deck:<svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path d="M2 10h20M2 10l10-7 10 7M4 10v11M20 10v11M2 21h20M8 14v7M12 14v7M16 14v7" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
  window:<svg width="24" height="24" fill="none" viewBox="0 0 24 24"><rect x="3" y="3" width="18" height="18" rx="2" stroke="#fff" strokeWidth="2"/><path d="M12 3v18M3 12h18" stroke="#fff" strokeWidth="2"/></svg>,
  paint:<svg width="24" height="24" fill="none" viewBox="0 0 24 24"><path d="M19 3H5a2 2 0 00-2 2v4a2 2 0 002 2h14a2 2 0 002-2V5a2 2 0 00-2-2zM12 11v5M10 22h4a1 1 0 001-1v-5a1 1 0 00-1-1h-4a1 1 0 00-1 1v5a1 1 0 001 1z" stroke="#fff" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/></svg>,
...
const iconMap={home:Ic.home,tool:Ic.tool,storm:Ic.storm,building:Ic.building,clipboard:Ic.clipboard,fence:Ic.fence,deck:Ic.deck,window:Ic.window,paint:Ic.paint};
        ...
        {step === 6 ? (
          ...
          <div className="bk-body">
            ...
            {step === 2 && (<>
              ...
              <div className="bk-field"><label>Phone Number *</label><input type="tel" value={contact.phone} onChange={e => setContact(c => ({ ...c, phone: e.target.value }))} placeholder="(210) 555-1234" /></div>
            ...
            {step === 5 && (<>
              ...
              <p className="sub">{C.nameShort} offers competitive project financing to fit your budget.</p>
...
/* ================================================================
   MAIN
   ================================================================ */
export default function CasaRoofingLanding() {
  ...
  return (
    <>
      ...
      <div className="tb">
        <span className="el">BBB A+ Since 2018</span>
        Call Now: <a href={`tel:${C.phoneRaw}`}>{C.phone}</a>
      </div>

      {/* HERO — San Antonio skyline vibe */}
        ...
        <div className="ctn"><div className="hg">
          <div className="ht">
            ...
            <div className="hb">
              ...
              <div className="bdg">{Ic.star} 5-Star Reviews</div>
              <div className="bdg">{Ic.clk} {C.yearsExp} Years Experience</div>
            </div>
            <h1>Phoenix's <span>Trusted</span> Roofing Experts</h1>
            <p>Roofing, gutters, fencing, decking, windows, and painting — {C.nameShort} handles it all. 40 five-star reviews and trusted by homeowners across {C.serviceArea}.</p>
            <div className="pc"><span className="orl">Or call &rarr;</span><a href={`tel:${C.phoneRaw}`}>{C.phone}</a></div>
          </div>
          <div className="fc">
            <h2>Book Consultation</h2>
              <p className="sh">Schedule your free consultation in under 60 seconds.</p>
      ...
      <div className="gal"><div className="gal-grid">
        {IMG.gallery.map((src, i) => <img key={i} src={src} alt={`Completed project ${i + 1}`} />)}
      </div></div>

      {/* AREAS TICKER */}
      <div className="as"><div className="as-inner">{areaList.map((a, i) => <span key={i}><span className="dot">&#x2726;</span> {a}, AZ</span>)}</div></div>

      {/* SERVICES — full one-stop-shop offering */}
      <section className="svcs"><div className="ctn">
        <div className="sh2"><h2>Our Services</h2><p>Everything your home's exterior needs — one crew, one call, done right.</p></div>
      ...
      <section className="split"><div className="ctn"><div className="split-grid">
        ...
        <div className="split-txt">
          <h2>One Crew. Every Exterior Need.</h2>
          <p>{C.nameShort} isn't just a roofing company — we're a full-service home exterior team. From your roof to your fence, gutters to windows, we handle it all so you don't have to juggle multiple contractors.</p>
          <p>Owner {C.owner} built {C.nameShort} on a simple promise: treat every home like it's your own. That approach has earned 40 five-star Google reviews and a reputation across the Phoenix metro you can count on.</p>
          <div><span className="tag">BBB A+ Since 2018</span><span className="tag">Owner-Operated</span><span className="tag">6 Services, 1 Call</span><span className="tag">Competitive Financing</span></div>
        </div>
      </div></div></section>

      {/* WHY US */}
      <section className="wu"><div className="ctn">
        <div className="sh2"><h2>Why {C.nameShort}?</h2><p>Here's what sets us apart across Phoenix and beyond</p></div>
        <div className="wg">
          <div className="wi"><div className="wn">01</div><h3>One-Stop Shop</h3><p>Roofing, gutters, fencing, decking, windows, painting — no need to call six different companies.</p></div>
          <div className="wi"><div className="wn">02</div><h3>BBB A+ Rated</h3><p>Accredited since 2018. Our reputation is built on honest work and standing behind every project.</p></div>
          <div className="wi"><div className="wn">03</div><h3>5-Star Reviews</h3><p>Consistently top-rated on Google, Facebook, and Yelp. Our customers speak for themselves.</p></div>
          <div className="wi"><div className="wn">04</div><h3>Financing Available</h3><p>Competitive project financing so you can protect your home without the full upfront cost.</p></div>
        </div>
      </div></section>

      {/* REVIEWS */}
      <section className="rv"><div className="ctn">
        <div className="sh2"><h2>What Customers Say</h2><p>Real reviews from Phoenix area homeowners</p></div>
      ...
      <section className="split" style={{ background: "var(--g50)" }}><div className="ctn"><div className="split-grid">
        <div className="split-txt">
          <h2>Storm Damage? We've Got You.</h2>
          <p>Arizona monsoons and hail don't mess around — and neither do we. {C.nameShort} handles the full insurance claim process so you can focus on your family while we focus on your roof.</p>
          <p>From initial inspection to adjuster meetings to final install, Randy and his crew manage every step. No runaround, no surprises.</p>
      ...
      <section className="fin"><div className="ctn">
        <h2>Competitive Financing Available</h2>
        <p>Quality work shouldn't break the bank. {C.nameShort} offers flexible project financing to fit your budget.</p>
        <div className="pills">
      ...
      <section className="bc"><div className="ctn">
        <h2>Protect Your Home — Inside and Out</h2>
        <p>Free inspection. Honest estimate. One crew for every exterior need. No pressure — just straight answers from Phoenix's most trusted roofing team.</p>
        ...
        <div className="pb">Call Now: <a href={`tel:${C.phoneRaw}`}>{C.phone}</a></div>
      </div></section>

      <footer className="ft">&copy; 2026 {C.name} All rights reserved. | Licensed &amp; Insured | Serving Phoenix &amp; Surrounding Areas | <a href={`mailto:${C.email}`}>{C.email}</a></footer>
